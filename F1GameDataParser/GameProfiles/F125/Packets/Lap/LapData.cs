...
namespace F1GameDataParser.GameProfiles.F125.Packets.Lap
{
    ...
    public struct LapData
    {
        ...
        public byte deltaToCarInFrontMinutesPart; // F1 24
        public ushort deltaToRaceLeaderInMS;
        public byte deltaToRaceLeaderMinutesPart; // F1 24
        ...
        public float speedTrapFastestSpeed;     // F1 24
        public byte speedTrapFastestLap;        // F1 24; Lap number the fastest speed was achieved, 255 = not set
    }
}
